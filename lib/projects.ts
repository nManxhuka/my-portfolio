...
export const projects: Project[] = [
  { slug: "silent-ai", number: "01", title: "Silent AI", subtitle: "Enterprise AI platform for knowledge management and orchestration.", description: "Knowledge management, AI chat, connectors, and data orchestration.", category: "Enterprise AI platform", role: "Senior Product Designer", timeline: "Placeholder timeline", platform: "Web platform", technologies: ["AI chat", "Connectors", "Data orchestration"], accent: "#8d5cff" },
