...
export const projects: Project[] = [
  ...
  { slug: "jamorder", number: "04", title: "JamOrder", subtitle: "Digital ordering and payment for hospitality service—at the table, on the move, and in the room.", description: "Hospitality ordering and payment across in-house, pickup, delivery, POS-supported service, and room service.", category: "Hospitality platform", role: "Senior Product Designer", timeline: "Not disclosed", platform: "Web & mobile", technologies: ["Ordering", "POS", "Service design"], accent: "#e15d42", heroVideo: "/assets/projects/jamorder/jamorder-flow.mp4", heroPoster: "/assets/projects/jamorder/jamorder-flow-poster.jpg" },
